class ProveedorsController < ApplicationController
  ...
  private
    ...
    def proveedor_params
      params.require(:proveedor).permit(:tipoCedula, :cedula, :fechaNacimiento, :personaNombre, :personaApellido, :personaTelefono, :personaMovil, :personaEmail, :personaDireccion, :nit, :empresaNombre, :empresaDireccion, :empresaTelefono, :empresaEmail, :paginaWeb, :foto, :cuentaContable, :fechaInicio, :fechaFin, :usuarios_id)
    end
end
