class WelcomesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @welcome.save
        format.html { redirect_to new_usuario_registration_path, notice: 'Sus datos han sifo guardados exitosamente.' }
  ...
  private
    ...
    def welcome_params
      params.require(:welcome).permit(:nombreEmpresa, :moneda, :nit, :nombreEncargado, :telEncargado, :telEmpresa, :direccionEmpresa, :correoEncargado, :cover)
    end
end
