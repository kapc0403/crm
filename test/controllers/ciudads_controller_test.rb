...
class CiudadsControllerTest < ActionController::TestCase
  ...
  test "should create ciudad" do
    assert_difference('Ciudad.count') do
      post :create, ciudad: { Departamento_id: @ciudad.Departamento_id, nombreCiudad: @ciudad.nombreCiudad }
    end
  ...
  test "should update ciudad" do
    patch :update, id: @ciudad, ciudad: { Departamento_id: @ciudad.Departamento_id, nombreCiudad: @ciudad.nombreCiudad }
    assert_redirected_to ciudad_path(assigns(:ciudad))
  end
