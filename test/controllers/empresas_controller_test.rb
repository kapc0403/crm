...
class EmpresasControllerTest < ActionController::TestCase
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post :create, empresa: { Direccion: @empresa.Direccion, Encargado: @empresa.Encargado, Nombre: @empresa.Nombre, Telefono: @empresa.Telefono }
    end
  ...
  test "should update empresa" do
    patch :update, id: @empresa, empresa: { Direccion: @empresa.Direccion, Encargado: @empresa.Encargado, Nombre: @empresa.Nombre, Telefono: @empresa.Telefono }
    assert_redirected_to empresa_path(assigns(:empresa))
  end
